    ...
    return (
        <section className="relative min-h-screen w-full flex flex-col pt-20 md:pt-0">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-transparent to-background-dark z-10" />
                <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-designer-primary/10 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
                <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-developer-primary/10 rounded-full blur-[120px] mix-blend-screen animate-pulse" style={{ animationDelay: '2s' }} />
            </div>
            ...
            <div className="flex-1 flex flex-col md:flex-row relative z-20">
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-end px-6 md:px-12 py-12 md:py-0 border-b md:border-b-0 md:border-r border-white/5 relative group transition-all duration-500 hover:bg-white/[0.02]">
                    ...
                    <div className="text-center md:text-right max-w-lg">
                        ...
                        >
                            <h2 className="text-xl md:text-2xl font-light text-designer-accent mb-2 tracking-widest">CREATE</h2>
                            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold font-heading text-transparent bg-clip-text bg-gradient-to-br from-designer-primary to-designer-secondary mb-4 leading-tight">
                                SKETCH
                            </h1>
                        </motion.div>
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center items-center md:items-start px-6 md:px-12 py-12 md:py-0 relative group transition-all duration-500 hover:bg-white/[0.02]">
                    ...
                    <div className="text-center md:text-left max-w-lg">
                        <motion.div
                            ...
                            transition={{ duration: 0.8, delay: 0.2 }}
                        >
                            <h2 className="text-xl md:text-2xl font-light text-developer-accent mb-2 tracking-widest font-mono">BUILD</h2>
                            <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold font-heading text-transparent bg-clip-text bg-gradient-to-bl from-developer-primary to-developer-secondary mb-4 leading-tight">
                                SHIP
                            </h1>
                        </motion.div>
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 pointer-events-none hidden md:flex items-center justify-center">
                ...
                >
                    <span className="text-4xl font-bold text-white bg-clip-text bg-gradient-to-r from-designer-primary to-developer-primary text-transparent">&</span>
                </motion.div>
            </div>
            ...
            <div className="w-full bg-background-dark/50 backdrop-blur-md border-t border-white/5 py-8 z-30">
                ...
                >
                    ...
                    <div>
                        <Button
                            size="lg"
                            className="bg-white text-black hover:bg-white/90 font-bold rounded-full px-8 py-4 text-base shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_40px_rgba(255,255,255,0.4)] transition-shadow"
                            data-hover="true"
                        >
                            Register Now
                        </Button>
